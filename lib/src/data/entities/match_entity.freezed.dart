...
mixin _$MatchEntity {
 ...
 String get id; String get eventId; String get name; TeamEntity get firstTeam; TeamEntity get secondTeam; List<ScoreEntity> get scores; int get maxScore; bool get halfScoreToEliminate; bool get ended; DateTime get createdAt; DateTime get updatedAt; DateTime? get endedAt;
...
@useResult
$Res call({
 String id, String eventId, String name, TeamEntity firstTeam, TeamEntity secondTeam, List<ScoreEntity> scores, int maxScore, bool halfScoreToEliminate, bool ended, DateTime createdAt, DateTime updatedAt, DateTime? endedAt
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String eventId,  String name,  TeamEntity firstTeam,  TeamEntity secondTeam,  List<ScoreEntity> scores,  int maxScore,  bool halfScoreToEliminate,  bool ended,  DateTime createdAt,  DateTime updatedAt,  DateTime? endedAt)  $default,) {final _that = this;
switch (_that) {
case _MatchEntity():
return $default(_that.id,_that.eventId,_that.name,_that.firstTeam,_that.secondTeam,_that.scores,_that.maxScore,_that.halfScoreToEliminate,_that.ended,_that.createdAt,_that.updatedAt,_that.endedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String eventId,  String name,  TeamEntity firstTeam,  TeamEntity secondTeam,  List<ScoreEntity> scores,  int maxScore,  bool halfScoreToEliminate,  bool ended,  DateTime createdAt,  DateTime updatedAt,  DateTime? endedAt)?  $default,) {final _that = this;
switch (_that) {
case _MatchEntity() when $default != null:
return $default(_that.id,_that.eventId,_that.name,_that.firstTeam,_that.secondTeam,_that.scores,_that.maxScore,_that.halfScoreToEliminate,_that.ended,_that.createdAt,_that.updatedAt,_that.endedAt);case _:
  return null;
