...
mixin _$TeamEntity {
 ...
 String get id; String get eventId; String get name; List<PlayerEntity> get players; DateTime get createdAt; DateTime get updatedAt;
...
@useResult
$Res call({
 String id, String eventId, String name, List<PlayerEntity> players, DateTime createdAt, DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String eventId,  String name,  List<PlayerEntity> players,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TeamEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String eventId,  String name,  List<PlayerEntity> players,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _TeamEntity():
return $default(_that.id,_that.eventId,_that.name,_that.players,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String eventId,  String name,  List<PlayerEntity> players,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _TeamEntity() when $default != null:
return $default(_that.id,_that.eventId,_that.name,_that.players,_that.createdAt,_that.updatedAt);case _:
  return null;
